...
import Independent.Circle2D;

/**
 * Created by Gary Kasameyer on 7/30/2018.
...
public class Exercise_11 {
    public static void main(String[] args) {
        ...
        System.out.printf("c1.contains(3, 3): %1b\n", c1.contains(3, 3));
        System.out.printf("c1.contains(new Circle2D(4, 5, 10.5): %1b\n", c1.contains(new Circle2D(4, 5, 10.5)));
        System.out.printf("c1.overlaps(new Circle2D(3, 5, 2.3): %1b\n", c1.overlaps(new Circle2D(3, 5, 2.3)));
    }
}
